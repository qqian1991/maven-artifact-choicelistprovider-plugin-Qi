...
public class ArtifactorySearchServiceTest extends TestCase {
	...
	public void testWithoutExplicitQualifier() throws VersionReaderException {
		...
		List<String> retrieveVersions
                = s.retrieveVersions("org.jenkins-ci.plugins", "maven-artifact-choicelistprovider", "", "", "", ValidAndInvalidClassifier.getDefault());
	...
	public void testWithExplicitQualifier() throws VersionReaderException {
		ArtifactorySearchService s = new ArtifactorySearchService("https://repo.jenkins-ci.org/");
		List<String> retrieveVersions
                = s.retrieveVersions("org.jenkins-ci.plugins", "maven-artifact-choicelistprovider", "", "", "", ValidAndInvalidClassifier.fromString("sources"));
		for (String current : retrieveVersions) {
			System.out.println(current);
		}
	}
	...
	public void testWithPackaging() throws VersionReaderException {
		ArtifactorySearchService s = new ArtifactorySearchService("https://repo.jenkins-ci.org/");
		List<String> retrieveVersions
                = s.retrieveVersions("org.jenkins-ci.plugins",
    ...
    @Test
    public void testWithVersionQualifier() throws VersionReaderException {
        ArtifactorySearchService s = new ArtifactorySearchService("https://repo.jenkins-ci.org/");
        List<String> retrieveVersions
                = s.retrieveVersions(
    ...
    @Test
    public void testWithReposQualifier() throws VersionReaderException {
        ArtifactorySearchService s = new ArtifactorySearchService("https://repo.jenkins-ci.org/");
        List<String> retrieveVersions
                = s.retrieveVersions(
                "org.jenkins-ci.plugins",
    ...
    @Test
    public void testWithVersionAndReposQualifier() throws VersionReaderException {
        ArtifactorySearchService s = new ArtifactorySearchService("https://repo.jenkins-ci.org/");
        List<String> retrieveVersions
                = s.retrieveVersions(
                "org.jenkins-ci.plugins",
